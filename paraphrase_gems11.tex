...
\begin{tabular}{c|ccc}
\hline \hline
{\bf \scriptsize BiP Paraphrase}& \multicolumn{3}{|c} {\bf \scriptsize MonoDS LSH Score} \\
{\bf \scriptsize Score} & \scriptsize $\ge$ 0.05 & \scriptsize $\ge$ 0.01 & \scriptsize $\ge$ 6.7e-3 \\
\hline
\scriptsize $\ge$ 0.9 & \scriptsize 4.18/4.40 & \scriptsize 4.05/4.39 & \scriptsize 4.03/4.37\\
\scriptsize $\ge$ 0.8 & \scriptsize 3.96/4.26 & \scriptsize 3.89/4.27 & \scriptsize 3.85/4.20\\
\scriptsize $\ge$ 0.7 & \scriptsize 3.92/4.11 & \scriptsize  3.84/4.18 & \scriptsize 3.79/4.11\\
\hline
\end{tabular}
\end{center}
\caption{Averaged human judgment scores (Meaning/Grammar) as a function of combined paraphrase and binned LSH score criteria.}
\label{table9b}
\end{table}
