...
\marginpar{add back some details that were omitted due to acl short ppr constaint?}
...
%\bf \scriptsize Re-ranking & \multicolumn{3}{c} {@3} &  \multicolumn{3}{c}{@6} &  \multicolumn{3}{c}{@10} &  \multicolumn{3}{c}{@15} &  \multicolumn{3}{c}{@20} &  \multicolumn{3}{c}{@30} \\
 & \multicolumn{2}{c} {\scriptsize Hiero-Hiero} &  \multicolumn{2}{c}{\scriptsize Hiero-LSH} &  \multicolumn{2}{c}{\scriptsize SAMT-SAMT} &  \multicolumn{2}{c}{\scriptsize SAMT-LSH} \\
...
% mention LSH consistently beat other score in each category
...
%%%%%%%%%%%%% Average of Top K meaning and grammar for each re-ranking score 
\begin{table*}%[t!]
\begin{center}
