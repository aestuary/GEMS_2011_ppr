...
such as by Lin and Pantel, distributional context is defined as the frequency
within which a given element appears in various syntactic positions with respect
to other lexical items. For example, the nouns \emph{apple} and \emph{orange}
are contextually similar partly owing to their shared tendency to be the object
...
design), it was not feasible to parse, which led to the use of unigram contexts.
...
\begin{tabular}{c|ccc}
\hline \hline
{\bf \scriptsize MonoDS }& \multicolumn{3}{|c} {\bf \scriptsize BiP Paraphrase Score} \\
{\bf \scriptsize LSH Score} & \scriptsize $\ge$ 0.05 & \scriptsize $\ge$ 0.01 & \scriptsize $\ge$ 6.7e-3 \\
\hline
