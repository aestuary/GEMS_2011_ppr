...
Judges evaluated the paraphrase quality through a substitution test.  We selected 500 sentences
 which contained 100 test phrase and substituted the phrase with automatically-generated paraphrases.   Judges indicated whether the paraphrases had the same meaning as the original and whether the resulting sentences were grammatical.  They assigned two values to each sentence using the 5-point scales given in Table \ref{annotation-guidelines}.  \mnote{these guidelines can be dropped, in which case, just point to my EMNLP 2008 paper for the guidelines}


\begin{table}
\begin{center}
\small
\begin{tabular}{lp{.87\linewidth}}
\hline
 \multicolumn{2}{|c|}{{\sc Meaning}} \\
\hline
...
\begin{tabular}{cp{.87\linewidth}}
\hline
 \multicolumn{2}{|c|}{{\sc Grammar}} \\
\hline
5	&	The sentence with the paraphrase inserted is perfectly grammatical\\
% and would require no correction\\
...
\normalsize
\end{center}
\caption{Judges scored paraphrases with two 5-point scales.}\label{annotation-guidelines}  
\end{table}
