...
For both the pilot study and the more detailed evaluation using human judgment collected from Mechanical Turk (Sections \ref{sect:results_pilot} and Section \ref{sect:results_fr_end}), the French-English parallel data from the Europarl corpus\cite{Koehn05} was used to train the paraphrase model. *add on* This is a much larger bilingual corpus than Urdu-English and therefore produces much higher 

\mnote{add on: size of fr\_en and stats similar to ur-en above}

\subsection{Method and Experimental Design}
...
\subsection{Evaluation on Paraphrase Pivoting Via French}
...
\bf \footnotesize MonoDS & \bf \footnotesize BiP \\ \hline
{\scriptsize willing (0.992)} & {\scriptsize not (0.558)} & {\scriptsize } \\
{\scriptsize loath (0.983)} & {\scriptsize unwilling (0.041)} & {\scriptsize } \\
{\scriptsize somewhat reluctant (0.98)} & {\scriptsize reluctance (0.031)}& {\scriptsize } \\
{\scriptsize unable (0.976)} & {\scriptsize reticent (0.025)} \\
{\scriptsize denied access (0.976)} &  {\scriptsize hesitant (0.016)} & {\scriptsize } \\
{\scriptsize disinclined (0.976)}&  {\scriptsize reticent about (0.014)} & {\scriptsize } \\
{\scriptsize very unwilling (0.974)} &  {\scriptsize reservations (0.011)} & {\scriptsize } \\
{\scriptsize conducive (0.973)}&  {\scriptsize reticence (0.010)} & {\scriptsize } \\
{\scriptsize linked (0.973)}&  {\scriptsize hesitate (0.009)} & {\scriptsize } \\
{\scriptsize less willing (0.973)}&  {\scriptsize are reluctant (0.009)} & {\scriptsize } \\
\hline
\end{tabular}
\end{center}
\caption{Top 10 re-ranked paraphrase candidates according to monolingual distributional similarity (MonoDS) and bilingual pivoting paraphrase (BiP) scores. The corresponding scores are indicated in brackets}
\label{table} 
\end{table}
