...
\textit{let us waste no more time : let us invest in infrastructure , transport networks , the environment and energy ; let us organize ourselves better , so that small and medium-sized enterprises can benefit from research investment and the member states can reduce the \textbf{fiscal burden} consisting of taxes and social contributions .}
